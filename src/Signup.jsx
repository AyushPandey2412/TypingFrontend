  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl">
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-4 sm:p-6 md:p-8 relative shadow-2xl">
          {/* Close button for modal */}
          {onCancel && (
            <button
              onClick={onCancel}
              className="absolute top-3 right-3 sm:top-4 sm:right-4 text-gray-400 hover:text-white transition-colors z-10 p-1"
            >
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-green-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
            ...
            <p className="text-gray-400 mt-2 text-sm sm:text-base">Join us and start typing faster</p>
          </div>
          ...
          {/* Success Message */}
          {success && (
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3 mb-4 sm:mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Choose a username"
                  value={sInfo.username}
                  className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                  disabled={isLoading}
                />
              </div>
            </div>
          ...
          <div className="mt-4 sm:mt-6 text-center">
            ...
            <p className="text-gray-400 text-xs sm:text-sm">
              ...
              <button
                onClick={handleLoginRoute}
                className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200 underline sm:no-underline sm:hover:underline"
              >
                Sign in
              </button>
            </p>
          ...
          <div className="mt-4 sm:mt-6 text-center px-2">
            <p className="text-xs text-gray-500 leading-relaxed">
              By creating an account, you agree to our{" "}
              <span className="text-blue-400 hover:text-blue-300 cursor-pointer underline">Terms of Service</span>{" "}
              and{" "}
              <span className="text-blue-400 hover:text-blue-300 cursor-pointer underline">Privacy Policy</span>
            </p>
          </div>
        </div>
      </div>
